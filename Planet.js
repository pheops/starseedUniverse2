...
class Planet {
  ...
  spawnMoons(total, level) {
    ...
    for (let i = 0; i < total; i++) {
      ...
      let d = random(this.radius + r, (this.radius + r) * 5);
  ...
  show() {
    ...
    //stroke(255);
    //line(255, 0, 0, this.v.x, this.v.y, this.v.z);
    //line(255, 0, 0, p.x, p.y, p.z);
    ...
    box(this.radius*2, this.radius*2, this.radius*2)
    //plane(this.radius*2,this.radius*2)
    //sphere(this.radius);
